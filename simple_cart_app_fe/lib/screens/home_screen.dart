...
class HomeScreen extends StatelessWidget {
          ...
          slivers: [
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text('Welcome back', 
                              style: TextStyle(fontSize: 24, color: Colors.grey[500], letterSpacing: 0.5)),
                            const Text('Lahiru Lakshan', 
            ...
            const SliverToBoxAdapter(
              child: Padding(
                ...
                child: Text(
                  "Curated Collection", 
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF1A1A1A), letterSpacing: -0.5),
                ),
              ),
            ),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) => _buildLuxuryProductCard(products[index]),
    ...
    return Container(
      ...
      child: const TextField(
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.search_rounded, color: Colors.black87, size: 22),
  ...
  Widget _buildLuxuryProductCard(Product product) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: [
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.favorite_border_rounded, size: 18, color: Colors.black),
                  ),
                ),
              ],
            ),
